...
Environment Variables:
    JENKINS_URL     - Jenkins base URL (default: https://jenkins.internal.vinesight.com)
    JENKINS_USER    - Jenkins API user (default: jenkins-healthchecks)
    JENKINS_TOKEN   - Jenkins API token (default: jenkins-healthchecks)
